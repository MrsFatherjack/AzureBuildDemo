...
DECLARE @ProductCategory VARCHAR(100) = 'BIKES'
...
SELECT COUNT(*) AS Products FROM BUILD.Locale_Product WHERE LocaleID = @LocaleID
SELECT COUNT(*) AS ProductCategory FROM BUILD.Locale_ProductCategory WHERE LocaleID = @LocaleID
SELECT COUNT(*) AS ProductSubCategory FROM BUILD.Locale_ProductSubCategory WHERE LocaleID = @LocaleID
